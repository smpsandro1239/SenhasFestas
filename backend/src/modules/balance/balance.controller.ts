import { Controller, Get, Param, Post, Body, UseGuards, Request, ForbiddenException } from '@nestjs/common';
...
export class BalanceController {
  ...
  @Get(':userId')
  async getBalance(@Param('userId') userId: string, @Request() req: any) {
